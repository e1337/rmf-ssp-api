...
CREATE TABLE IF NOT EXISTS `RMF`.`potential_assessment_objects` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `potential_assesment_id` INT NOT NULL,
  `object` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `potential_assessment_objects_fk0`
    FOREIGN KEY (`potential_assesment_id`)
    REFERENCES `RMF`.`potential_assessments` (`id`));

CREATE INDEX `potential_assessment_objects_fk0` ON `RMF`.`potential_assessment_objects` (`potential_assesment_id` ASC);
